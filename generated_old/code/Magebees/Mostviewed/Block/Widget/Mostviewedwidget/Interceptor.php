<?php
namespace Magebees\Mostviewed\Block\Widget\Mostviewedwidget;

/**
 * Interceptor class for @see \Magebees\Mostviewed\Block\Widget\Mostviewedwidget
 */
class Interceptor extends \Magebees\Mostviewed\Block\Widget\Mostviewedwidget implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\App\ResourceConnection $resource, \Magento\Framework\Url\Helper\Data $urlHelper, \Magebees\Mostviewed\Model\ResourceModel\Customcollection\Collection $mvmanualCollection, \Magento\CatalogInventory\Helper\Stock $stockHelper, \Magento\Reports\Model\ResourceModel\Product\CollectionFactory $reportModel, \Magento\Catalog\Model\Product\Visibility $visibilityModel, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Framework\Stdlib\DateTime\DateTime $datetime, \Magento\Sales\Model\Order\Status\History $orderstatus, \Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\Framework\ObjectManagerInterface $objectManager, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $resource, $urlHelper, $mvmanualCollection, $stockHelper, $reportModel, $visibilityModel, $productCollectionFactory, $datetime, $orderstatus, $resourceConnection, $objectManager, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderconfig');
        if (!$pluginInfo) {
            return parent::getSliderconfig();
        } else {
            return $this->___callPlugins('getSliderconfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWidgetOptions');
        if (!$pluginInfo) {
            return parent::setWidgetOptions();
        } else {
            return $this->___callPlugins('setWidgetOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setConfigValues');
        if (!$pluginInfo) {
            return parent::setConfigValues();
        } else {
            return $this->___callPlugins('setConfigValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAutoMostviewedCollection');
        if (!$pluginInfo) {
            return parent::getAutoMostviewedCollection();
        } else {
            return $this->___callPlugins('getAutoMostviewedCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getManualMostviewedCollection');
        if (!$pluginInfo) {
            return parent::getManualMostviewedCollection();
        } else {
            return $this->___callPlugins('getManualMostviewedCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMostviewedsCollection');
        if (!$pluginInfo) {
            return parent::getMostviewedsCollection();
        } else {
            return $this->___callPlugins('getMostviewedsCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsIds');
        if (!$pluginInfo) {
            return parent::getProductsIds();
        } else {
            return $this->___callPlugins('getProductsIds', func_get_args(), $pluginInfo);
        }
    }
