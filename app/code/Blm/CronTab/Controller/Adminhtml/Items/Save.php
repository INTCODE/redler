...
class Save extends \Blm\CronTab\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('blm/crontab');
                        ...
                        $imagePath = 'blm/crontab'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('blm_crontab/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('blm_crontab/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('blm_crontab/*/new');
                }
                return;
            } catch (\Exception $e) {
