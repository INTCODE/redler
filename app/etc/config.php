...
return [
    'modules' => [
        ...
        'Magento_Signifyd' => 1,
        'Magento_Sitemap' => 1,
        'LizardMedia_AllProductsListing' => 0,
        ...
        'Mbs_ProductDetailQtyWidget' => 0,
        'RLTSquare_AjaxShoppingCartUpdate' => 0,
        'RLTSquare_BestSeller' => 0,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1
    ]
];
